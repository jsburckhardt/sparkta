...
Implement the supplied interface prompt directly in this standalone app. Begin with the current app source and deliver the requested frontend experience; do not attempt parent-repository discovery, GitHub issue workflows, RPIV stages, engineering-harness orchestration, or Soft Factory Runner orchestration. Keep every implementation write inside this app boundary.
